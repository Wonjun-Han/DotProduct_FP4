...
module p_Adder_Groupwise_1(
  ...
  assign io_out_mantissa_0 =
    enable_depth ? (sum[45] ? 45'h0 - sum[44:0] : sum[44:0]) : 45'h0;
  assign io_out_mantissa_1 =
    enable_depth ? (sum_1[45] ? 45'h0 - sum_1[44:0] : sum_1[44:0]) : 45'h0;
  assign io_out_sign_0 = enable_depth & sum[45];
  assign io_out_sign_1 = enable_depth & sum_1[45];
endmodule
