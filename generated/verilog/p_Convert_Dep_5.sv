...
module p_Convert_Dep_5(
  ...
  wire [1052:0] _mantissa_conv_T =
    {1023'h0, _abs_val_full_T_4, 17'h0}
    << {6'h0, $signed(_shift_amt_T_1) < 4'sh0 ? 4'h0 - _shift_amt_T_1 : _shift_amt_T_1}
    - (10'h1 - _biased_exp_T);
  wire [29:0]   _mantissa_conv_T_4 = {_abs_val_full_T_4, 17'h0} >> _shift_amt_T_1;
  wire [44:0]   _mantissa_conv_T_12 =
  ...
  wire [1052:0] _mantissa_conv_T_15 =
    {1023'h0, _abs_val_full_T_9, 17'h0}
    << {6'h0, $signed(_shift_amt_T_4) < 4'sh0 ? 4'h0 - _shift_amt_T_4 : _shift_amt_T_4}
    - (10'h1 - _biased_exp_T_2);
  wire [29:0]   _mantissa_conv_T_19 = {_abs_val_full_T_9, 17'h0} >> _shift_amt_T_4;
  wire [44:0]   _mantissa_conv_T_27 =
  ...
  wire [1052:0] _mantissa_conv_T_30 =
    {1023'h0, _abs_val_full_T_14, 17'h0}
    << {6'h0, $signed(_shift_amt_T_7) < 4'sh0 ? 4'h0 - _shift_amt_T_7 : _shift_amt_T_7}
    - (10'h1 - _biased_exp_T_4);
  wire [29:0]   _mantissa_conv_T_34 = {_abs_val_full_T_14, 17'h0} >> _shift_amt_T_7;
  wire [44:0]   _mantissa_conv_T_42 =
  ...
  wire [1052:0] _mantissa_conv_T_45 =
    {1023'h0, _abs_val_full_T_19, 17'h0}
    << {6'h0, $signed(_shift_amt_T_10) < 4'sh0 ? 4'h0 - _shift_amt_T_10 : _shift_amt_T_10}
    - (10'h1 - _biased_exp_T_6);
  wire [29:0]   _mantissa_conv_T_49 = {_abs_val_full_T_19, 17'h0} >> _shift_amt_T_10;
  wire [44:0]   _mantissa_conv_T_57 =
  ...
  wire [1052:0] _mantissa_conv_T_60 =
    {1023'h0, _abs_val_full_T_24, 17'h0}
    << {6'h0, $signed(_shift_amt_T_13) < 4'sh0 ? 4'h0 - _shift_amt_T_13 : _shift_amt_T_13}
    - (10'h1 - _biased_exp_T_8);
  wire [29:0]   _mantissa_conv_T_64 = {_abs_val_full_T_24, 17'h0} >> _shift_amt_T_13;
  wire [44:0]   _mantissa_conv_T_72 =
  ...
  wire [1052:0] _mantissa_conv_T_75 =
    {1023'h0, _abs_val_full_T_29, 17'h0}
    << {6'h0, $signed(_shift_amt_T_16) < 4'sh0 ? 4'h0 - _shift_amt_T_16 : _shift_amt_T_16}
    - (10'h1 - _biased_exp_T_10);
  wire [29:0]   _mantissa_conv_T_79 = {_abs_val_full_T_29, 17'h0} >> _shift_amt_T_16;
  wire [44:0]   _mantissa_conv_T_87 =
  ...
  wire [1052:0] _mantissa_conv_T_90 =
    {1023'h0, _abs_val_full_T_34, 17'h0}
    << {6'h0, $signed(_shift_amt_T_19) < 4'sh0 ? 4'h0 - _shift_amt_T_19 : _shift_amt_T_19}
    - (10'h1 - _biased_exp_T_12);
  wire [29:0]   _mantissa_conv_T_94 = {_abs_val_full_T_34, 17'h0} >> _shift_amt_T_19;
  wire [44:0]   _mantissa_conv_T_102 =
  ...
  wire [1052:0] _mantissa_conv_T_105 =
    {1023'h0, _abs_val_full_T_39, 17'h0}
    << {6'h0, $signed(_shift_amt_T_22) < 4'sh0 ? 4'h0 - _shift_amt_T_22 : _shift_amt_T_22}
    - (10'h1 - _biased_exp_T_14);
  wire [29:0]   _mantissa_conv_T_109 = {_abs_val_full_T_39, 17'h0} >> _shift_amt_T_22;
  wire [44:0]   _mantissa_conv_T_117 =
    {15'h0, _abs_val_full_T_39, 17'h0}
    << ($signed(_shift_amt_T_22) < 4'sh0 ? 4'h0 - _shift_amt_T_22 : _shift_amt_T_22);
  assign io_out_0_sign = enable & ~io_nan_0 & sign_bit;
  assign io_out_0_exponent =
    enable ? (io_nan_0 | _GEN ? 8'hFF : _GEN_0 ? 8'h0 : _biased_exp_T[7:0]) : 8'h0;
           ...
           : _GEN
               ...
               : _GEN_0
                   ...
                   : $signed(_shift_amt_T_1) > -4'sh1
                       ...
                       : _mantissa_conv_T_12[22:0])
      : 23'h0;
  assign io_out_1_sign = enable & ~io_nan_1 & sign_bit_1;
  assign io_out_1_exponent =
    enable ? (io_nan_1 | _GEN_1 ? 8'hFF : _GEN_2 ? 8'h0 : _biased_exp_T_2[7:0]) : 8'h0;
           ...
           : _GEN_1
               ...
               : _GEN_2
                   ...
                   : $signed(_shift_amt_T_4) > -4'sh1
                       ? _mantissa_conv_T_19[22:0]
                       : _mantissa_conv_T_27[22:0])
      : 23'h0;
  assign io_out_2_sign = enable & ~io_nan_2 & sign_bit_2;
  assign io_out_2_exponent =
    enable ? (io_nan_2 | _GEN_3 ? 8'hFF : _GEN_4 ? 8'h0 : _biased_exp_T_4[7:0]) : 8'h0;
           ...
           : _GEN_3
               ...
               : _GEN_4
                   ...
                   : $signed(_shift_amt_T_7) > -4'sh1
                       ? _mantissa_conv_T_34[22:0]
                       : _mantissa_conv_T_42[22:0])
      : 23'h0;
  assign io_out_3_sign = enable & ~io_nan_3 & sign_bit_3;
  assign io_out_3_exponent =
    enable ? (io_nan_3 | _GEN_5 ? 8'hFF : _GEN_6 ? 8'h0 : _biased_exp_T_6[7:0]) : 8'h0;
    ...
    enable
      ? (io_nan_3
           ...
           : _GEN_5
               ? 23'h0
               : _GEN_6
                   ? _mantissa_conv_T_45[22:0]
                   : $signed(_shift_amt_T_10) > -4'sh1
                       ? _mantissa_conv_T_49[22:0]
                       : _mantissa_conv_T_57[22:0])
      : 23'h0;
  assign io_out_4_sign = enable & ~io_nan_4 & sign_bit_4;
  assign io_out_4_exponent =
    enable ? (io_nan_4 | _GEN_7 ? 8'hFF : _GEN_8 ? 8'h0 : _biased_exp_T_8[7:0]) : 8'h0;
    ...
    enable
      ? (io_nan_4
           ...
           : _GEN_7
               ? 23'h0
               : _GEN_8
                   ? _mantissa_conv_T_60[22:0]
                   : $signed(_shift_amt_T_13) > -4'sh1
                       ? _mantissa_conv_T_64[22:0]
                       : _mantissa_conv_T_72[22:0])
      : 23'h0;
  assign io_out_5_sign = enable & ~io_nan_5 & sign_bit_5;
  assign io_out_5_exponent =
    enable ? (io_nan_5 | _GEN_9 ? 8'hFF : _GEN_10 ? 8'h0 : _biased_exp_T_10[7:0]) : 8'h0;
           ...
           : _GEN_9
               ...
               : _GEN_10
                   ...
                   : $signed(_shift_amt_T_16) > -4'sh1
                       ? _mantissa_conv_T_79[22:0]
                       : _mantissa_conv_T_87[22:0])
      : 23'h0;
  assign io_out_6_sign = enable & ~io_nan_6 & sign_bit_6;
  assign io_out_6_exponent =
    enable ? (io_nan_6 | _GEN_11 ? 8'hFF : _GEN_12 ? 8'h0 : _biased_exp_T_12[7:0]) : 8'h0;
    ...
    enable
      ? (io_nan_6
           ...
           : _GEN_11
               ? 23'h0
               : _GEN_12
                   ? _mantissa_conv_T_90[22:0]
                   : $signed(_shift_amt_T_19) > -4'sh1
                       ? _mantissa_conv_T_94[22:0]
                       : _mantissa_conv_T_102[22:0])
      : 23'h0;
  assign io_out_7_sign = enable & ~io_nan_7 & sign_bit_7;
  assign io_out_7_exponent =
    enable ? (io_nan_7 | _GEN_13 ? 8'hFF : _GEN_14 ? 8'h0 : _biased_exp_T_14[7:0]) : 8'h0;
    ...
    enable
      ? (io_nan_7
           ...
           : _GEN_13
               ? 23'h0
               : _GEN_14
                   ? _mantissa_conv_T_105[22:0]
                   : $signed(_shift_amt_T_22) > -4'sh1
                       ? _mantissa_conv_T_109[22:0]
                       : _mantissa_conv_T_117[22:0])
      : 23'h0;
