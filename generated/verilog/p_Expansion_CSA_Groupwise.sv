...
module p_Expansion_CSA_Groupwise(
  input         clock,
                reset,
  input  [13:0] io_in_0,
                io_in_1,
  ...
  output        io_out_sign_0,
                ...
                io_out_sign_6,
                io_out_sign_7,
  output [8:0]  io_out_exponent_gmax_0,
  ...
  wire [8:0]      cands_0 =
    ~(|(expansion_size[3:1])) | laneZero_0 ? 9'h100 : io_exponent_0;
  wire [8:0]      cands_1 =
    ~(|(expansion_size[3:1])) | laneZero_1 ? 9'h100 : io_exponent_1;
  wire            cands_ok_2 = expansion_size > 4'h2;
  wire [8:0]      cands_2 = ~cands_ok_2 | laneZero_2 ? 9'h100 : io_exponent_2;
  wire [8:0]      cands_3 =
    ~(|(expansion_size[3:2])) | laneZero_3 ? 9'h100 : io_exponent_3;
  wire            cands_ok_4 = expansion_size > 4'h4;
  wire [8:0]      cands_4 = ~cands_ok_4 | laneZero_4 ? 9'h100 : io_exponent_4;
  wire            cands_ok_5 = expansion_size > 4'h5;
  wire [8:0]      cands_5 = ~cands_ok_5 | laneZero_5 ? 9'h100 : io_exponent_5;
  wire            cands_ok_6 = expansion_size > 4'h6;
  wire [8:0]      cands_6 = ~cands_ok_6 | laneZero_6 ? 9'h100 : io_exponent_6;
  wire [8:0]      cands_7 = ~(expansion_size[3]) | laneZero_7 ? 9'h100 : io_exponent_7;
  wire [8:0]      grpMax_pairs_0 =
    $signed(cands_0) > $signed(cands_1) ? cands_0 : cands_1;
  wire [8:0]      grpMax_pairs_1 =
    $signed(cands_2) > $signed(cands_3) ? cands_2 : cands_3;
  wire [8:0]      grpMax_pairs_2 =
    $signed(cands_4) > $signed(cands_5) ? cands_4 : cands_5;
  wire [8:0]      grpMax_pairs_3 =
    $signed(cands_6) > $signed(cands_7) ? cands_6 : cands_7;
  wire [8:0]      grpMax_pairs_0_1 =
    $signed(grpMax_pairs_0) > $signed(grpMax_pairs_1) ? grpMax_pairs_0 : grpMax_pairs_1;
  wire [8:0]      grpMax_pairs_1_1 =
    $signed(grpMax_pairs_2) > $signed(grpMax_pairs_3) ? grpMax_pairs_2 : grpMax_pairs_3;
  wire [8:0]      grpMax =
    $signed(grpMax_pairs_0_1) > $signed(grpMax_pairs_1_1)
      ? grpMax_pairs_0_1
      : grpMax_pairs_1_1;
  wire [8:0]      grouped_max_exp_0 = active ? grpMax : 9'h0;
  ...
  wire [3:0][8:0] _GEN_5 =
    {{active_3 ? grpMax_3 : 9'h0},
     {active_2 ? grpMax_2 : 9'h0},
     {active_1 ? grpMax_1 : 9'h0},
     {grouped_max_exp_0}};
  ...
  assign io_out_exponent_gmax_0 = enable & (|expansion_num) & active ? grpMax : 9'h0;
  assign io_out_exponent_gmax_1 =
    enable & (|(expansion_num[2:1])) & active_1 ? grpMax_1 : 9'h0;
  assign io_out_exponent_gmax_2 =
    enable & _io_out_exponent_gmax_2_T & active_2 ? grpMax_2 : 9'h0;
  assign io_out_exponent_gmax_3 = enable & expansion_num[2] & active_3 ? grpMax_3 : 9'h0;
endmodule
