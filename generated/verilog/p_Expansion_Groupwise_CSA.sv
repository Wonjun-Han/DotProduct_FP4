...
module p_Expansion_Groupwise_CSA(
  input  [13:0] io_in_0,
                io_in_1,
                io_in_2,
                io_in_3,
  ...
  wire [9:0]      cands_0 =
    ~(|(expansion_size[3:1])) | laneZero_0 ? 10'h300 : io_exponent_0;
  wire [9:0]      cands_1 =
    ~(|(expansion_size[3:1])) | laneZero_1 ? 10'h300 : io_exponent_1;
  wire            cands_ok_2 = expansion_size > 4'h2;
  wire [9:0]      cands_2 = ~cands_ok_2 | laneZero_2 ? 10'h300 : io_exponent_2;
  wire [9:0]      cands_3 =
    ~(|(expansion_size[3:2])) | laneZero_3 ? 10'h300 : io_exponent_3;
  wire            cands_ok_4 = expansion_size > 4'h4;
  wire [9:0]      cands_4 = ~cands_ok_4 | laneZero_4 ? 10'h300 : io_exponent_4;
  wire            cands_ok_5 = expansion_size > 4'h5;
  wire [9:0]      cands_5 = ~cands_ok_5 | laneZero_5 ? 10'h300 : io_exponent_5;
  wire            cands_ok_6 = expansion_size > 4'h6;
  wire [9:0]      cands_6 = ~cands_ok_6 | laneZero_6 ? 10'h300 : io_exponent_6;
  wire [9:0]      cands_7 = ~(expansion_size[3]) | laneZero_7 ? 10'h300 : io_exponent_7;
  ...
  wire [3:0][9:0] _GEN_7 =
    {{enable & expansion_num[2]
        ? ($signed(l2_0_3) > $signed(l2_1_3) ? l2_0_3 : l2_1_3)
        : 10'h0},
     {enable & expansion_num > 3'h2
        ? ($signed(l2_0_2) > $signed(l2_1_2) ? l2_0_2 : l2_1_2)
        : 10'h0},
     {enable & (|(expansion_num[2:1]))
        ? ($signed(l2_0_1) > $signed(l2_1_1) ? l2_0_1 : l2_1_1)
        : 10'h0},
     {grouped_max_exp_0}};
  ...
  assign io_out_exponent_gmax_0 = enable & (|expansion_num) & active ? grpMax[8:0] : 9'h0;
endmodule
