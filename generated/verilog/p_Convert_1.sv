...
module p_Convert_1(
  ...
  wire          enable_depth = io_depth == 4'h2;
  wire          sign_bit = $signed(io_in_0) < 11'sh0;
  wire [9:0]    abs_val_eff =
    enable_depth & ~io_nan_0 & (|io_in_0)
      ? (sign_bit ? 10'h0 - io_in_0[9:0] : io_in_0[9:0])
      : 10'h0;
  wire [6:0]    _PE_T =
    (|(abs_val_eff[9:2])) ? abs_val_eff[9:3] : {abs_val_eff[1:0], 5'h0};
  wire [2:0]    _PE_T_4 = (|(_PE_T[6:3])) ? _PE_T[6:4] : _PE_T[2:0];
  wire [3:0]    _PE_T_7 =
    (|(_PE_T[6:3]))
      ? {~(|(abs_val_eff[9:2])), 3'h0}
      : {~(|(abs_val_eff[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_11 = (|(_PE_T_4[2:1])) ? _PE_T_7 : _PE_T_7 + 4'h2;
  wire [3:0]    _PE_T_15 =
    ((|(_PE_T_4[2:1])) ? _PE_T_4[2] : _PE_T_4[0]) ? _PE_T_11 : _PE_T_11 + 4'h1;
  wire [3:0]    _shift_amt_T_1 = 4'h3 - (_PE_T_15 > 4'hA ? 4'hA : _PE_T_15);
  wire [26:0]   extended_mantissa = {abs_val_eff, 17'h0};
  ...
  wire [9:0]    _sub_shift_T_10 =
    ...
    - (10'h1 - _biased_exp_T);
  wire [1049:0] _mant_sub_T =
    {1023'h0, abs_val_eff, 17'h0}
    << (_sub_shift_T_10 > 10'h1A ? 10'h1A : _sub_shift_T_10);
  wire [9:0]    _sub_shift_r_cap_T = 10'h0 - _sub_shift_T_10;
  wire [26:0]   _mant_sub_T_2 =
    extended_mantissa >> (_sub_shift_r_cap_T > 10'h1A ? 10'h1A : _sub_shift_r_cap_T);
  wire [26:0]   _mant_norm_T = extended_mantissa >> _shift_amt_T_1;
  wire [57:0]   _mant_norm_T_2 = {31'h0, abs_val_eff, 17'h0} << 4'h0 - _shift_amt_T_1;
  wire          sign_bit_1 = $signed(io_in_1) < 11'sh0;
  wire [9:0]    abs_val_eff_1 =
    enable_depth & ~io_nan_0 & (|io_in_1)
      ? (sign_bit_1 ? 10'h0 - io_in_1[9:0] : io_in_1[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_17 =
    (|(abs_val_eff_1[9:2])) ? abs_val_eff_1[9:3] : {abs_val_eff_1[1:0], 5'h0};
  wire [2:0]    _PE_T_21 = (|(_PE_T_17[6:3])) ? _PE_T_17[6:4] : _PE_T_17[2:0];
  wire [3:0]    _PE_T_24 =
    (|(_PE_T_17[6:3]))
      ? {~(|(abs_val_eff_1[9:2])), 3'h0}
      : {~(|(abs_val_eff_1[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_28 = (|(_PE_T_21[2:1])) ? _PE_T_24 : _PE_T_24 + 4'h2;
  wire [3:0]    _PE_T_32 =
    ((|(_PE_T_21[2:1])) ? _PE_T_21[2] : _PE_T_21[0]) ? _PE_T_28 : _PE_T_28 + 4'h1;
  wire [3:0]    _shift_amt_T_4 = 4'h3 - (_PE_T_32 > 4'hA ? 4'hA : _PE_T_32);
  wire [26:0]   extended_mantissa_1 = {abs_val_eff_1, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_4 =
    {1023'h0, abs_val_eff_1, 17'h0}
    << (_sub_shift_T_22 > 10'h1A ? 10'h1A : _sub_shift_T_22);
  wire [9:0]    _sub_shift_r_cap_T_4 = 10'h0 - _sub_shift_T_22;
  wire [26:0]   _mant_sub_T_6 =
    extended_mantissa_1
    >> (_sub_shift_r_cap_T_4 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_4);
  wire [26:0]   _mant_norm_T_4 = extended_mantissa_1 >> _shift_amt_T_4;
  wire [57:0]   _mant_norm_T_6 = {31'h0, abs_val_eff_1, 17'h0} << 4'h0 - _shift_amt_T_4;
  wire          sign_bit_2 = $signed(io_in_2) < 11'sh0;
  wire [9:0]    abs_val_eff_2 =
    enable_depth & ~io_nan_0 & (|io_in_2)
      ? (sign_bit_2 ? 10'h0 - io_in_2[9:0] : io_in_2[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_34 =
    (|(abs_val_eff_2[9:2])) ? abs_val_eff_2[9:3] : {abs_val_eff_2[1:0], 5'h0};
  wire [2:0]    _PE_T_38 = (|(_PE_T_34[6:3])) ? _PE_T_34[6:4] : _PE_T_34[2:0];
  wire [3:0]    _PE_T_41 =
    (|(_PE_T_34[6:3]))
      ? {~(|(abs_val_eff_2[9:2])), 3'h0}
      : {~(|(abs_val_eff_2[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_45 = (|(_PE_T_38[2:1])) ? _PE_T_41 : _PE_T_41 + 4'h2;
  wire [3:0]    _PE_T_49 =
    ((|(_PE_T_38[2:1])) ? _PE_T_38[2] : _PE_T_38[0]) ? _PE_T_45 : _PE_T_45 + 4'h1;
  wire [3:0]    _shift_amt_T_7 = 4'h3 - (_PE_T_49 > 4'hA ? 4'hA : _PE_T_49);
  wire [26:0]   extended_mantissa_2 = {abs_val_eff_2, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_8 =
    {1023'h0, abs_val_eff_2, 17'h0}
    << (_sub_shift_T_34 > 10'h1A ? 10'h1A : _sub_shift_T_34);
  wire [9:0]    _sub_shift_r_cap_T_8 = 10'h0 - _sub_shift_T_34;
  wire [26:0]   _mant_sub_T_10 =
    extended_mantissa_2
    >> (_sub_shift_r_cap_T_8 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_8);
  wire [26:0]   _mant_norm_T_8 = extended_mantissa_2 >> _shift_amt_T_7;
  wire [57:0]   _mant_norm_T_10 = {31'h0, abs_val_eff_2, 17'h0} << 4'h0 - _shift_amt_T_7;
  wire          sign_bit_3 = $signed(io_in_3) < 11'sh0;
  wire [9:0]    abs_val_eff_3 =
    enable_depth & ~io_nan_0 & (|io_in_3)
      ? (sign_bit_3 ? 10'h0 - io_in_3[9:0] : io_in_3[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_51 =
    (|(abs_val_eff_3[9:2])) ? abs_val_eff_3[9:3] : {abs_val_eff_3[1:0], 5'h0};
  wire [2:0]    _PE_T_55 = (|(_PE_T_51[6:3])) ? _PE_T_51[6:4] : _PE_T_51[2:0];
  wire [3:0]    _PE_T_58 =
    (|(_PE_T_51[6:3]))
      ? {~(|(abs_val_eff_3[9:2])), 3'h0}
      : {~(|(abs_val_eff_3[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_62 = (|(_PE_T_55[2:1])) ? _PE_T_58 : _PE_T_58 + 4'h2;
  wire [3:0]    _PE_T_66 =
    ((|(_PE_T_55[2:1])) ? _PE_T_55[2] : _PE_T_55[0]) ? _PE_T_62 : _PE_T_62 + 4'h1;
  wire [3:0]    _shift_amt_T_10 = 4'h3 - (_PE_T_66 > 4'hA ? 4'hA : _PE_T_66);
  wire [26:0]   extended_mantissa_3 = {abs_val_eff_3, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_12 =
    {1023'h0, abs_val_eff_3, 17'h0}
    << (_sub_shift_T_46 > 10'h1A ? 10'h1A : _sub_shift_T_46);
  wire [9:0]    _sub_shift_r_cap_T_12 = 10'h0 - _sub_shift_T_46;
  wire [26:0]   _mant_sub_T_14 =
    extended_mantissa_3
    >> (_sub_shift_r_cap_T_12 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_12);
  wire [26:0]   _mant_norm_T_12 = extended_mantissa_3 >> _shift_amt_T_10;
  wire [57:0]   _mant_norm_T_14 = {31'h0, abs_val_eff_3, 17'h0} << 4'h0 - _shift_amt_T_10;
  wire          sign_bit_4 = $signed(io_in_4) < 11'sh0;
  wire [9:0]    abs_val_eff_4 =
    enable_depth & ~io_nan_0 & (|io_in_4)
      ? (sign_bit_4 ? 10'h0 - io_in_4[9:0] : io_in_4[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_68 =
    (|(abs_val_eff_4[9:2])) ? abs_val_eff_4[9:3] : {abs_val_eff_4[1:0], 5'h0};
  wire [2:0]    _PE_T_72 = (|(_PE_T_68[6:3])) ? _PE_T_68[6:4] : _PE_T_68[2:0];
  wire [3:0]    _PE_T_75 =
    (|(_PE_T_68[6:3]))
      ? {~(|(abs_val_eff_4[9:2])), 3'h0}
      : {~(|(abs_val_eff_4[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_79 = (|(_PE_T_72[2:1])) ? _PE_T_75 : _PE_T_75 + 4'h2;
  wire [3:0]    _PE_T_83 =
    ((|(_PE_T_72[2:1])) ? _PE_T_72[2] : _PE_T_72[0]) ? _PE_T_79 : _PE_T_79 + 4'h1;
  wire [3:0]    _shift_amt_T_13 = 4'h3 - (_PE_T_83 > 4'hA ? 4'hA : _PE_T_83);
  wire [26:0]   extended_mantissa_4 = {abs_val_eff_4, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_16 =
    {1023'h0, abs_val_eff_4, 17'h0}
    << (_sub_shift_T_58 > 10'h1A ? 10'h1A : _sub_shift_T_58);
  wire [9:0]    _sub_shift_r_cap_T_16 = 10'h0 - _sub_shift_T_58;
  wire [26:0]   _mant_sub_T_18 =
    extended_mantissa_4
    >> (_sub_shift_r_cap_T_16 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_16);
  wire [26:0]   _mant_norm_T_16 = extended_mantissa_4 >> _shift_amt_T_13;
  wire [57:0]   _mant_norm_T_18 = {31'h0, abs_val_eff_4, 17'h0} << 4'h0 - _shift_amt_T_13;
  wire          sign_bit_5 = $signed(io_in_5) < 11'sh0;
  wire [9:0]    abs_val_eff_5 =
    enable_depth & ~io_nan_0 & (|io_in_5)
      ? (sign_bit_5 ? 10'h0 - io_in_5[9:0] : io_in_5[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_85 =
    (|(abs_val_eff_5[9:2])) ? abs_val_eff_5[9:3] : {abs_val_eff_5[1:0], 5'h0};
  wire [2:0]    _PE_T_89 = (|(_PE_T_85[6:3])) ? _PE_T_85[6:4] : _PE_T_85[2:0];
  wire [3:0]    _PE_T_92 =
    (|(_PE_T_85[6:3]))
      ? {~(|(abs_val_eff_5[9:2])), 3'h0}
      : {~(|(abs_val_eff_5[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_96 = (|(_PE_T_89[2:1])) ? _PE_T_92 : _PE_T_92 + 4'h2;
  wire [3:0]    _PE_T_100 =
    ((|(_PE_T_89[2:1])) ? _PE_T_89[2] : _PE_T_89[0]) ? _PE_T_96 : _PE_T_96 + 4'h1;
  wire [3:0]    _shift_amt_T_16 = 4'h3 - (_PE_T_100 > 4'hA ? 4'hA : _PE_T_100);
  wire [26:0]   extended_mantissa_5 = {abs_val_eff_5, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_20 =
    {1023'h0, abs_val_eff_5, 17'h0}
    << (_sub_shift_T_70 > 10'h1A ? 10'h1A : _sub_shift_T_70);
  wire [9:0]    _sub_shift_r_cap_T_20 = 10'h0 - _sub_shift_T_70;
  wire [26:0]   _mant_sub_T_22 =
    extended_mantissa_5
    >> (_sub_shift_r_cap_T_20 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_20);
  wire [26:0]   _mant_norm_T_20 = extended_mantissa_5 >> _shift_amt_T_16;
  wire [57:0]   _mant_norm_T_22 = {31'h0, abs_val_eff_5, 17'h0} << 4'h0 - _shift_amt_T_16;
  wire          sign_bit_6 = $signed(io_in_6) < 11'sh0;
  wire [9:0]    abs_val_eff_6 =
    enable_depth & ~io_nan_0 & (|io_in_6)
      ? (sign_bit_6 ? 10'h0 - io_in_6[9:0] : io_in_6[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_102 =
    (|(abs_val_eff_6[9:2])) ? abs_val_eff_6[9:3] : {abs_val_eff_6[1:0], 5'h0};
  wire [2:0]    _PE_T_106 = (|(_PE_T_102[6:3])) ? _PE_T_102[6:4] : _PE_T_102[2:0];
  wire [3:0]    _PE_T_109 =
    (|(_PE_T_102[6:3]))
      ? {~(|(abs_val_eff_6[9:2])), 3'h0}
      : {~(|(abs_val_eff_6[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_113 = (|(_PE_T_106[2:1])) ? _PE_T_109 : _PE_T_109 + 4'h2;
  wire [3:0]    _PE_T_117 =
    ((|(_PE_T_106[2:1])) ? _PE_T_106[2] : _PE_T_106[0]) ? _PE_T_113 : _PE_T_113 + 4'h1;
  wire [3:0]    _shift_amt_T_19 = 4'h3 - (_PE_T_117 > 4'hA ? 4'hA : _PE_T_117);
  wire [26:0]   extended_mantissa_6 = {abs_val_eff_6, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_24 =
    {1023'h0, abs_val_eff_6, 17'h0}
    << (_sub_shift_T_82 > 10'h1A ? 10'h1A : _sub_shift_T_82);
  wire [9:0]    _sub_shift_r_cap_T_24 = 10'h0 - _sub_shift_T_82;
  wire [26:0]   _mant_sub_T_26 =
    extended_mantissa_6
    >> (_sub_shift_r_cap_T_24 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_24);
  wire [26:0]   _mant_norm_T_24 = extended_mantissa_6 >> _shift_amt_T_19;
  wire [57:0]   _mant_norm_T_26 = {31'h0, abs_val_eff_6, 17'h0} << 4'h0 - _shift_amt_T_19;
  wire          sign_bit_7 = $signed(io_in_7) < 11'sh0;
  wire [9:0]    abs_val_eff_7 =
    enable_depth & ~io_nan_0 & (|io_in_7)
      ? (sign_bit_7 ? 10'h0 - io_in_7[9:0] : io_in_7[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_119 =
    (|(abs_val_eff_7[9:2])) ? abs_val_eff_7[9:3] : {abs_val_eff_7[1:0], 5'h0};
  wire [2:0]    _PE_T_123 = (|(_PE_T_119[6:3])) ? _PE_T_119[6:4] : _PE_T_119[2:0];
  wire [3:0]    _PE_T_126 =
    (|(_PE_T_119[6:3]))
      ? {~(|(abs_val_eff_7[9:2])), 3'h0}
      : {~(|(abs_val_eff_7[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_130 = (|(_PE_T_123[2:1])) ? _PE_T_126 : _PE_T_126 + 4'h2;
  wire [3:0]    _PE_T_134 =
    ((|(_PE_T_123[2:1])) ? _PE_T_123[2] : _PE_T_123[0]) ? _PE_T_130 : _PE_T_130 + 4'h1;
  wire [3:0]    _shift_amt_T_22 = 4'h3 - (_PE_T_134 > 4'hA ? 4'hA : _PE_T_134);
  wire [26:0]   extended_mantissa_7 = {abs_val_eff_7, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_28 =
    {1023'h0, abs_val_eff_7, 17'h0}
    << (_sub_shift_T_94 > 10'h1A ? 10'h1A : _sub_shift_T_94);
  wire [9:0]    _sub_shift_r_cap_T_28 = 10'h0 - _sub_shift_T_94;
  wire [26:0]   _mant_sub_T_30 =
    extended_mantissa_7
    >> (_sub_shift_r_cap_T_28 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_28);
  wire [26:0]   _mant_norm_T_28 = extended_mantissa_7 >> _shift_amt_T_22;
  wire [57:0]   _mant_norm_T_30 = {31'h0, abs_val_eff_7, 17'h0} << 4'h0 - _shift_amt_T_22;
  wire          sign_bit_8 = $signed(io_in_8) < 11'sh0;
  wire [9:0]    abs_val_eff_8 =
    enable_depth & ~io_nan_1 & (|io_in_8)
      ? (sign_bit_8 ? 10'h0 - io_in_8[9:0] : io_in_8[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_136 =
    (|(abs_val_eff_8[9:2])) ? abs_val_eff_8[9:3] : {abs_val_eff_8[1:0], 5'h0};
  wire [2:0]    _PE_T_140 = (|(_PE_T_136[6:3])) ? _PE_T_136[6:4] : _PE_T_136[2:0];
  wire [3:0]    _PE_T_143 =
    (|(_PE_T_136[6:3]))
      ? {~(|(abs_val_eff_8[9:2])), 3'h0}
      : {~(|(abs_val_eff_8[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_147 = (|(_PE_T_140[2:1])) ? _PE_T_143 : _PE_T_143 + 4'h2;
  wire [3:0]    _PE_T_151 =
    ((|(_PE_T_140[2:1])) ? _PE_T_140[2] : _PE_T_140[0]) ? _PE_T_147 : _PE_T_147 + 4'h1;
  wire [3:0]    _shift_amt_T_25 = 4'h3 - (_PE_T_151 > 4'hA ? 4'hA : _PE_T_151);
  wire [26:0]   extended_mantissa_8 = {abs_val_eff_8, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_32 =
    {1023'h0, abs_val_eff_8, 17'h0}
    << (_sub_shift_T_106 > 10'h1A ? 10'h1A : _sub_shift_T_106);
  wire [9:0]    _sub_shift_r_cap_T_32 = 10'h0 - _sub_shift_T_106;
  wire [26:0]   _mant_sub_T_34 =
    extended_mantissa_8
    >> (_sub_shift_r_cap_T_32 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_32);
  wire [26:0]   _mant_norm_T_32 = extended_mantissa_8 >> _shift_amt_T_25;
  wire [57:0]   _mant_norm_T_34 = {31'h0, abs_val_eff_8, 17'h0} << 4'h0 - _shift_amt_T_25;
  wire          sign_bit_9 = $signed(io_in_9) < 11'sh0;
  wire [9:0]    abs_val_eff_9 =
    enable_depth & ~io_nan_1 & (|io_in_9)
      ? (sign_bit_9 ? 10'h0 - io_in_9[9:0] : io_in_9[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_153 =
    (|(abs_val_eff_9[9:2])) ? abs_val_eff_9[9:3] : {abs_val_eff_9[1:0], 5'h0};
  wire [2:0]    _PE_T_157 = (|(_PE_T_153[6:3])) ? _PE_T_153[6:4] : _PE_T_153[2:0];
  wire [3:0]    _PE_T_160 =
    (|(_PE_T_153[6:3]))
      ? {~(|(abs_val_eff_9[9:2])), 3'h0}
      : {~(|(abs_val_eff_9[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_164 = (|(_PE_T_157[2:1])) ? _PE_T_160 : _PE_T_160 + 4'h2;
  wire [3:0]    _PE_T_168 =
    ((|(_PE_T_157[2:1])) ? _PE_T_157[2] : _PE_T_157[0]) ? _PE_T_164 : _PE_T_164 + 4'h1;
  wire [3:0]    _shift_amt_T_28 = 4'h3 - (_PE_T_168 > 4'hA ? 4'hA : _PE_T_168);
  wire [26:0]   extended_mantissa_9 = {abs_val_eff_9, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_36 =
    {1023'h0, abs_val_eff_9, 17'h0}
    << (_sub_shift_T_118 > 10'h1A ? 10'h1A : _sub_shift_T_118);
  wire [9:0]    _sub_shift_r_cap_T_36 = 10'h0 - _sub_shift_T_118;
  wire [26:0]   _mant_sub_T_38 =
    extended_mantissa_9
    >> (_sub_shift_r_cap_T_36 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_36);
  wire [26:0]   _mant_norm_T_36 = extended_mantissa_9 >> _shift_amt_T_28;
  wire [57:0]   _mant_norm_T_38 = {31'h0, abs_val_eff_9, 17'h0} << 4'h0 - _shift_amt_T_28;
  wire          sign_bit_10 = $signed(io_in_10) < 11'sh0;
  wire [9:0]    abs_val_eff_10 =
    enable_depth & ~io_nan_1 & (|io_in_10)
      ? (sign_bit_10 ? 10'h0 - io_in_10[9:0] : io_in_10[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_170 =
    (|(abs_val_eff_10[9:2])) ? abs_val_eff_10[9:3] : {abs_val_eff_10[1:0], 5'h0};
  wire [2:0]    _PE_T_174 = (|(_PE_T_170[6:3])) ? _PE_T_170[6:4] : _PE_T_170[2:0];
  wire [3:0]    _PE_T_177 =
    (|(_PE_T_170[6:3]))
      ? {~(|(abs_val_eff_10[9:2])), 3'h0}
      : {~(|(abs_val_eff_10[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_181 = (|(_PE_T_174[2:1])) ? _PE_T_177 : _PE_T_177 + 4'h2;
  wire [3:0]    _PE_T_185 =
    ((|(_PE_T_174[2:1])) ? _PE_T_174[2] : _PE_T_174[0]) ? _PE_T_181 : _PE_T_181 + 4'h1;
  wire [3:0]    _shift_amt_T_31 = 4'h3 - (_PE_T_185 > 4'hA ? 4'hA : _PE_T_185);
  wire [26:0]   extended_mantissa_10 = {abs_val_eff_10, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_40 =
    {1023'h0, abs_val_eff_10, 17'h0}
    << (_sub_shift_T_130 > 10'h1A ? 10'h1A : _sub_shift_T_130);
  wire [9:0]    _sub_shift_r_cap_T_40 = 10'h0 - _sub_shift_T_130;
  wire [26:0]   _mant_sub_T_42 =
    extended_mantissa_10
    >> (_sub_shift_r_cap_T_40 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_40);
  wire [26:0]   _mant_norm_T_40 = extended_mantissa_10 >> _shift_amt_T_31;
  wire [57:0]   _mant_norm_T_42 =
    {31'h0, abs_val_eff_10, 17'h0} << 4'h0 - _shift_amt_T_31;
  wire          sign_bit_11 = $signed(io_in_11) < 11'sh0;
  wire [9:0]    abs_val_eff_11 =
    enable_depth & ~io_nan_1 & (|io_in_11)
      ? (sign_bit_11 ? 10'h0 - io_in_11[9:0] : io_in_11[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_187 =
    (|(abs_val_eff_11[9:2])) ? abs_val_eff_11[9:3] : {abs_val_eff_11[1:0], 5'h0};
  wire [2:0]    _PE_T_191 = (|(_PE_T_187[6:3])) ? _PE_T_187[6:4] : _PE_T_187[2:0];
  wire [3:0]    _PE_T_194 =
    (|(_PE_T_187[6:3]))
      ? {~(|(abs_val_eff_11[9:2])), 3'h0}
      : {~(|(abs_val_eff_11[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_198 = (|(_PE_T_191[2:1])) ? _PE_T_194 : _PE_T_194 + 4'h2;
  wire [3:0]    _PE_T_202 =
    ((|(_PE_T_191[2:1])) ? _PE_T_191[2] : _PE_T_191[0]) ? _PE_T_198 : _PE_T_198 + 4'h1;
  wire [3:0]    _shift_amt_T_34 = 4'h3 - (_PE_T_202 > 4'hA ? 4'hA : _PE_T_202);
  wire [26:0]   extended_mantissa_11 = {abs_val_eff_11, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_44 =
    {1023'h0, abs_val_eff_11, 17'h0}
    << (_sub_shift_T_142 > 10'h1A ? 10'h1A : _sub_shift_T_142);
  wire [9:0]    _sub_shift_r_cap_T_44 = 10'h0 - _sub_shift_T_142;
  wire [26:0]   _mant_sub_T_46 =
    extended_mantissa_11
    >> (_sub_shift_r_cap_T_44 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_44);
  wire [26:0]   _mant_norm_T_44 = extended_mantissa_11 >> _shift_amt_T_34;
  wire [57:0]   _mant_norm_T_46 =
    {31'h0, abs_val_eff_11, 17'h0} << 4'h0 - _shift_amt_T_34;
  wire          sign_bit_12 = $signed(io_in_12) < 11'sh0;
  wire [9:0]    abs_val_eff_12 =
    enable_depth & ~io_nan_1 & (|io_in_12)
      ? (sign_bit_12 ? 10'h0 - io_in_12[9:0] : io_in_12[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_204 =
    (|(abs_val_eff_12[9:2])) ? abs_val_eff_12[9:3] : {abs_val_eff_12[1:0], 5'h0};
  wire [2:0]    _PE_T_208 = (|(_PE_T_204[6:3])) ? _PE_T_204[6:4] : _PE_T_204[2:0];
  wire [3:0]    _PE_T_211 =
    (|(_PE_T_204[6:3]))
      ? {~(|(abs_val_eff_12[9:2])), 3'h0}
      : {~(|(abs_val_eff_12[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_215 = (|(_PE_T_208[2:1])) ? _PE_T_211 : _PE_T_211 + 4'h2;
  wire [3:0]    _PE_T_219 =
    ((|(_PE_T_208[2:1])) ? _PE_T_208[2] : _PE_T_208[0]) ? _PE_T_215 : _PE_T_215 + 4'h1;
  wire [3:0]    _shift_amt_T_37 = 4'h3 - (_PE_T_219 > 4'hA ? 4'hA : _PE_T_219);
  wire [26:0]   extended_mantissa_12 = {abs_val_eff_12, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_48 =
    {1023'h0, abs_val_eff_12, 17'h0}
    << (_sub_shift_T_154 > 10'h1A ? 10'h1A : _sub_shift_T_154);
  wire [9:0]    _sub_shift_r_cap_T_48 = 10'h0 - _sub_shift_T_154;
  wire [26:0]   _mant_sub_T_50 =
    extended_mantissa_12
    >> (_sub_shift_r_cap_T_48 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_48);
  wire [26:0]   _mant_norm_T_48 = extended_mantissa_12 >> _shift_amt_T_37;
  wire [57:0]   _mant_norm_T_50 =
    {31'h0, abs_val_eff_12, 17'h0} << 4'h0 - _shift_amt_T_37;
  wire          sign_bit_13 = $signed(io_in_13) < 11'sh0;
  wire [9:0]    abs_val_eff_13 =
    enable_depth & ~io_nan_1 & (|io_in_13)
      ? (sign_bit_13 ? 10'h0 - io_in_13[9:0] : io_in_13[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_221 =
    (|(abs_val_eff_13[9:2])) ? abs_val_eff_13[9:3] : {abs_val_eff_13[1:0], 5'h0};
  wire [2:0]    _PE_T_225 = (|(_PE_T_221[6:3])) ? _PE_T_221[6:4] : _PE_T_221[2:0];
  wire [3:0]    _PE_T_228 =
    (|(_PE_T_221[6:3]))
      ? {~(|(abs_val_eff_13[9:2])), 3'h0}
      : {~(|(abs_val_eff_13[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_232 = (|(_PE_T_225[2:1])) ? _PE_T_228 : _PE_T_228 + 4'h2;
  wire [3:0]    _PE_T_236 =
    ((|(_PE_T_225[2:1])) ? _PE_T_225[2] : _PE_T_225[0]) ? _PE_T_232 : _PE_T_232 + 4'h1;
  wire [3:0]    _shift_amt_T_40 = 4'h3 - (_PE_T_236 > 4'hA ? 4'hA : _PE_T_236);
  wire [26:0]   extended_mantissa_13 = {abs_val_eff_13, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_52 =
    {1023'h0, abs_val_eff_13, 17'h0}
    << (_sub_shift_T_166 > 10'h1A ? 10'h1A : _sub_shift_T_166);
  wire [9:0]    _sub_shift_r_cap_T_52 = 10'h0 - _sub_shift_T_166;
  wire [26:0]   _mant_sub_T_54 =
    extended_mantissa_13
    >> (_sub_shift_r_cap_T_52 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_52);
  wire [26:0]   _mant_norm_T_52 = extended_mantissa_13 >> _shift_amt_T_40;
  wire [57:0]   _mant_norm_T_54 =
    {31'h0, abs_val_eff_13, 17'h0} << 4'h0 - _shift_amt_T_40;
  wire          sign_bit_14 = $signed(io_in_14) < 11'sh0;
  wire [9:0]    abs_val_eff_14 =
    enable_depth & ~io_nan_1 & (|io_in_14)
      ? (sign_bit_14 ? 10'h0 - io_in_14[9:0] : io_in_14[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_238 =
    (|(abs_val_eff_14[9:2])) ? abs_val_eff_14[9:3] : {abs_val_eff_14[1:0], 5'h0};
  wire [2:0]    _PE_T_242 = (|(_PE_T_238[6:3])) ? _PE_T_238[6:4] : _PE_T_238[2:0];
  wire [3:0]    _PE_T_245 =
    (|(_PE_T_238[6:3]))
      ? {~(|(abs_val_eff_14[9:2])), 3'h0}
      : {~(|(abs_val_eff_14[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_249 = (|(_PE_T_242[2:1])) ? _PE_T_245 : _PE_T_245 + 4'h2;
  wire [3:0]    _PE_T_253 =
    ((|(_PE_T_242[2:1])) ? _PE_T_242[2] : _PE_T_242[0]) ? _PE_T_249 : _PE_T_249 + 4'h1;
  wire [3:0]    _shift_amt_T_43 = 4'h3 - (_PE_T_253 > 4'hA ? 4'hA : _PE_T_253);
  wire [26:0]   extended_mantissa_14 = {abs_val_eff_14, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_56 =
    {1023'h0, abs_val_eff_14, 17'h0}
    << (_sub_shift_T_178 > 10'h1A ? 10'h1A : _sub_shift_T_178);
  wire [9:0]    _sub_shift_r_cap_T_56 = 10'h0 - _sub_shift_T_178;
  wire [26:0]   _mant_sub_T_58 =
    extended_mantissa_14
    >> (_sub_shift_r_cap_T_56 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_56);
  wire [26:0]   _mant_norm_T_56 = extended_mantissa_14 >> _shift_amt_T_43;
  wire [57:0]   _mant_norm_T_58 =
    {31'h0, abs_val_eff_14, 17'h0} << 4'h0 - _shift_amt_T_43;
  wire          sign_bit_15 = $signed(io_in_15) < 11'sh0;
  wire [9:0]    abs_val_eff_15 =
    enable_depth & ~io_nan_1 & (|io_in_15)
      ? (sign_bit_15 ? 10'h0 - io_in_15[9:0] : io_in_15[9:0])
      : 10'h0;
  wire [6:0]    _PE_T_255 =
    (|(abs_val_eff_15[9:2])) ? abs_val_eff_15[9:3] : {abs_val_eff_15[1:0], 5'h0};
  wire [2:0]    _PE_T_259 = (|(_PE_T_255[6:3])) ? _PE_T_255[6:4] : _PE_T_255[2:0];
  wire [3:0]    _PE_T_262 =
    (|(_PE_T_255[6:3]))
      ? {~(|(abs_val_eff_15[9:2])), 3'h0}
      : {~(|(abs_val_eff_15[9:2])), 3'h0} + 4'h4;
  wire [3:0]    _PE_T_266 = (|(_PE_T_259[2:1])) ? _PE_T_262 : _PE_T_262 + 4'h2;
  wire [3:0]    _PE_T_270 =
    ((|(_PE_T_259[2:1])) ? _PE_T_259[2] : _PE_T_259[0]) ? _PE_T_266 : _PE_T_266 + 4'h1;
  wire [3:0]    _shift_amt_T_46 = 4'h3 - (_PE_T_270 > 4'hA ? 4'hA : _PE_T_270);
  wire [26:0]   extended_mantissa_15 = {abs_val_eff_15, 17'h0};
  ...
  wire [1049:0] _mant_sub_T_60 =
    {1023'h0, abs_val_eff_15, 17'h0}
    << (_sub_shift_T_190 > 10'h1A ? 10'h1A : _sub_shift_T_190);
  wire [9:0]    _sub_shift_r_cap_T_60 = 10'h0 - _sub_shift_T_190;
  wire [26:0]   _mant_sub_T_62 =
    extended_mantissa_15
    >> (_sub_shift_r_cap_T_60 > 10'h1A ? 10'h1A : _sub_shift_r_cap_T_60);
  wire [26:0]   _mant_norm_T_60 = extended_mantissa_15 >> _shift_amt_T_46;
  wire [57:0]   _mant_norm_T_62 =
  ...
  assign io_out_7_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_8_sign = enable_depth & ~io_nan_1 & sign_bit_8;
  ...
  assign io_out_8_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_9_sign = enable_depth & ~io_nan_1 & sign_bit_9;
  ...
  assign io_out_9_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_10_sign = enable_depth & ~io_nan_1 & sign_bit_10;
  ...
  assign io_out_10_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_11_sign = enable_depth & ~io_nan_1 & sign_bit_11;
  ...
  assign io_out_11_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_12_sign = enable_depth & ~io_nan_1 & sign_bit_12;
  ...
  assign io_out_12_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_13_sign = enable_depth & ~io_nan_1 & sign_bit_13;
  ...
  assign io_out_13_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_14_sign = enable_depth & ~io_nan_1 & sign_bit_14;
  ...
  assign io_out_14_mantissa =
    enable_depth
      ...
      : 23'h0;
  assign io_out_15_sign = enable_depth & ~io_nan_1 & sign_bit_15;
