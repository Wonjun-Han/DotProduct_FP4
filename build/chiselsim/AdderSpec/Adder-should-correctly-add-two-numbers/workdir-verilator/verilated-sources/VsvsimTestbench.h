...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_io_a(int* value);
    static void getBitWidthImpl_io_b(int* value);
    static void getBitWidthImpl_io_sum(int* value);
    static void getBitWidthImpl_reset(int* value);
    static void getBitsImpl_clock(svBitVecVal* value_clock);
    static void getBitsImpl_io_a(svBitVecVal* value_io_a);
    static void getBitsImpl_io_b(svBitVecVal* value_io_b);
    static void getBitsImpl_io_sum(svBitVecVal* value_io_sum);
    static void getBitsImpl_reset(svBitVecVal* value_reset);
    static void setBitsImpl_clock(const svBitVecVal* value_clock);
    static void setBitsImpl_io_a(const svBitVecVal* value_io_a);
    static void setBitsImpl_io_b(const svBitVecVal* value_io_b);
