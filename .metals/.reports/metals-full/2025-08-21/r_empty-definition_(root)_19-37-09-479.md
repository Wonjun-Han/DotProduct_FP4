file://<WORKSPACE>/src/main/scala/build/build.scala
...
non-local guesses:
	 -chisel3/p_CSA_unit#
	 -p_CSA_unit#
	 -scala/Predef.p_CSA_unit#
offset: 3359
uri: file://<WORKSPACE>/src/main/scala/build/build.scala
text:
```scala
package build
...
object build {
  def getModule(moduleName: String): RawModule = {
    moduleName match {
      ...
      case "p_CSA_unit" => new mxfp4.proposed.p_@@CSA_unit()
