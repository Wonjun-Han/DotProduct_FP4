...
class nv_p_TOP_Til_Dep_ALL_V1_IO extends Bundle {
...
class nv_p_TOP_Til_Dep_All_V1 extends Module {
  val io = IO(new nv_p_TOP_Til_Dep_ALL_V1_IO)

  val scale_sum = Module(new nv_p_Adder_ScaleSum)
  val mult = Module(new nv_p_Multiplier)
  val conv = Module(new nv_p_MulConvert)

  val expansion = Seq.fill(8)(Module(new nv_p_Expansion))
  val scale_emax = Module(new nv_p_Adder_ScaleEmax)

  val dep1 = Seq.fill(8)(Module(new nv_p_Adder_Dep_1))
  val dep2 = Seq.fill(8)(Module(new nv_p_Adder_Dep_2))
  val dep3 = Seq.fill(8)(Module(new nv_p_Adder_Dep_3))
  val dep4 = Seq.fill(8)(Module(new nv_p_Adder_Dep_4))
  val dep5 = Seq.fill(8)(Module(new nv_p_Adder_Dep_5))

  val convert_dep_1 = Module(new nv_p_Convert_Dep_1)
  val convert_dep_2 = Module(new nv_p_Convert_Dep_2)
  val convert_dep_3 = Module(new nv_p_Convert_Dep_3)
  val convert_dep_4 = Module(new nv_p_Convert_Dep_4)
  val convert_dep_5 = Module(new nv_p_Convert_Dep_5)
