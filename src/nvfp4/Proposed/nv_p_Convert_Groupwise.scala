...
class NVFP4_CONVERT_GROUPWISE_BLOCK_IO(depthBitWidth: Int, mantissaWidth: Int, vecSize: Int) extends Bundle {
...
class nv_p_Convert_Groupwise(val d: Int, val extra: Int) extends Module {
  ...
  val io = IO(new NVFP4_CONVERT_GROUPWISE_BLOCK_IO(
