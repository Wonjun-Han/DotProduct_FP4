...
class p_Expansion_CSA_Groupwise_IO(depthBitWidth: Int, accWidth: Int, vecSize: Int, outWidth: Int) extends Bundle {
...
class p_Expansion_CSA_Groupwise(val d: Int, val extra: Int) extends Module {
  val accWidth = 9 + d
  val outWidth = 8 + d + extra
  val vecSize = 256 >> d // d = 5 → vecSize = 8

  val io = IO(new p_Expansion_CSA_Groupwise_IO(
    depthBitWidth = 4,
    accWidth = accWidth,
    vecSize = vecSize,
    outWidth = outWidth
