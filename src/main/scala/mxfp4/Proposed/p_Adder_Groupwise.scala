...
class p_Adder_Groupwise_IO (depthBitWidth: Int, accWidth: Int, vecSize: Int, outWidth: Int) extends Bundle {
...
class p_Adder_Groupwise(val d: Int, val vecSize: Int, val extra: Int) extends Module {
